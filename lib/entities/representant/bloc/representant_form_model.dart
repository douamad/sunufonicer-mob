...
enum ActifValidationError { invalid }
class ActifInput extends FormzInput<bool, ActifValidationError> {
  const ActifInput.pure() : super.pure(false);
  const ActifInput.dirty([bool value = false]) : super.dirty(value);

  @override
  ActifValidationError? validator(bool value) {
    return null;
  }
}
