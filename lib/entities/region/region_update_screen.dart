      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            title: BlocBuilder<RegionBloc, RegionState>(
                ...
                String title = state.editMode == true ?'Edit Regions':
'Create Regions';
                 return Text(title);
                }
            ),
    ...
    return Form(
        ...
        return BlocBuilder<RegionBloc, RegionState>(
            ...
            builder: (context, state) {
              return TextFormField(
                  controller: context.read<RegionBloc>().codeController,
                  onChanged: (value) { context.read<RegionBloc>()
      ...
      Widget libelleField() {
        return BlocBuilder<RegionBloc, RegionState>(
            ...
            builder: (context, state) {
              return TextFormField(
                  controller: context.read<RegionBloc>().libelleController,
                  onChanged: (value) { context.read<RegionBloc>()
...
'Create';
          return RaisedButton(
            ...
            onPressed: state.formStatus.isValidated ? () => context.read<RegionBloc>().add(RegionFormSubmitted()) : null,
          );
        }
    );
  }
